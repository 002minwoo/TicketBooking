...
const ClassSeatComponent= memo((props)=> {
    ...
    const seat= useMemo(()=> [{v: t("Phổ thông"), e: "ECONOMY"}, {v: t("Phổ thông cao cấp"), e: "PREMIUM_ECONOMY"}, {v: t("Thương gia"), e: "BUSINESS"}, {v: t("Hạng nhất"), e: "FIRST"}], [])
    const myRef= useRef()
    ...
    return (
        <div className="cs-2">
            ...
            <div className="gr-1" ref={myRef} onClick={()=> setopensuggest(()=> true)} style={{ outline: opensuggest=== true ? "2px solid #2e89ff" : "none"}}>
                ...
                <div className="it-1">
                    <input type="text" value={t(props.value.v)} spellCheck={true} aria-invalid={false} autoCapitalize={"sentences"} autoComplete={"on"} dir="auto" className="it-1" readOnly={true} style={{textTransform: "capitalize"}}  />
                </div>
