    ...
    <div className="sk-2">
      <div className="ds-4">
        <Link to="/booking?q=flight" style={{ textDecoration: "none" }}>
          <S
            setbookplane={() => props.setbookplane(() => true)}
            icon={
              <svg
                width="14"
                height="14"
            ...
            title={t("Vé máy bay")}
          />
        </Link>
        <Link to="/booking?q=hotel" style={{ textDecoration: "none" }}>
          <S
            setbookplane={() => props.setbookplane(() => false)}
            icon={
              <svg
                width="1em"
                height="1em"
...
const S1 = (props) => {
  ...
  return <div className="ic-1">{props.icon}</div>;
};
const S2 = (props) => {
  const { t } = useTranslation();

  return <div className="te-1">{t(props.title)}</div>;
};
