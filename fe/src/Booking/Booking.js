          ...
          <>
            ...
            >
              ...
              <div className="sdfadfsasdaas" style={{ width: "49%" }}>
                ...
                <input
                  onChange={(e) =>
                    setagent((prev) => ({ ...prev, surname: e.target.value }))
                  }
                  type="text"
                  style={{
                    padding: 10,
            ...
            {location.state.ps && (
              <>
                {Array.from(
                  Array(parseInt(location.state.ps.split(".")[0])).keys()
                ).map((item, key) => (
                  <FormCustomer
                    setaccept={setaccept}
                ...
                {Array.from(
                  Array(parseInt(location.state.ps.split(".")[1])).keys()
                ).map((item, key) => (
                  <FormCustomer
                    setaccept={setaccept}
                    setalluser={setalluser}
                ...
                {Array.from(
                  Array(parseInt(location.state.ps.split(".")[2])).keys()
                ).map((item, key) => (
                  <FormCustomer
                    setaccept={setaccept}
                    setalluser={setalluser}
            ...
            {location.state.detail_customer && (
              <>
                {Array.from(
                  Array(
                    parseInt(location.state.detail_customer.split(".")[0])
                  ).keys()
                ).map((item, key) => (
                  <FormCustomer
                    setaccept={setaccept}
                ...
                {Array.from(
                  Array(
                    parseInt(location.state.detail_customer.split(".")[1])
                  ).keys()
                ).map((item, key) => (
                  <FormCustomer
                    setaccept={setaccept}
              ...
              {isConfirm === false && (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    width: "max-content",
                    cursor: accept === true ? "pointer" : "not-allowed",
                    display: "flex",
                    justifyContent: "center",
                    alignItems: "center",
              ...
              {isConfirm === true && (
                ...
                >
                  {loading === false ? (
                    ...
                    >
                      <CircularProgress
                        style={{ color: "#fff", width: 21.6, height: 21.6 }}
                      />
                    </div>
                  )}
                </button>
