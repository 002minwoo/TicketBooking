            ...
            <Box sx={{ minWidth: 120 }}>
                ...
                >
                    <FormControl sx={{ minWidth: 120 }} color={flight.seatclass?.length <= 0 ? "error" : "primary"} helperText={flight.seatclass?.length <= 0 ? <div style={{ color: "red" }}>Enter your seatclass</div> : <></>}>
                        ...
                        >
                            <MenuItem value={t("Phổ thông")}>{t("Phổ thông")}</MenuItem>
                            <MenuItem value={t("Phổ thông đặc biệt")}>{t("Phổ thông đặc biệt")}</MenuItem>
                            <MenuItem value={t("Thương gia")}>{t("Thương gia")}</MenuItem>
                            <MenuItem value={t("Hạng nhất")}>{t("Hạng nhất")}</MenuItem>
                        </Select>
                    </FormControl>
                </Box>
            </Box>
